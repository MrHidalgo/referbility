...
var initSwiper = function initSwiper() {
  ...
  var _revampTestimonialsSwiper = undefined;
  ...
  var _revampBlogSwiper = undefined;

  var _contactsSeenOpt = {
    effect: 'slide',
    speed: 750,
    slidesPerView: 1,
    spaceBetween: 30,
  ...
  var _contactsSeenSwiper = undefined;

  var _contactsUserOpt = {
    effect: 'slide',
    speed: 750,
    slidesPerView: 1,
    spaceBetween: 30,
  ...
  * ============================================= */
  ...
  var initBoardCard = function initBoardCard() {
    ...
    function stickyDetailsBlock() {
      ...
      var _boardDetailsHeight = $('[board-details-js]').height(),
  ...
  var initPostingAction = function initPostingAction() {
    ...
    $('[posting-review-js]').on('click', function (ev) {
      ...
      $(".posting__btn-wrapper [posting-review-js]").removeClass('c-btn--bg-gradient').addClass('c-btn--bg-green').find('span').text($(".posting__btn-wrapper [posting-review-js]").data('name'));
    ...
    $('[plan-checkbox-js]').on('change', function (ev) {
      var _el = $(ev.currentTarget),
